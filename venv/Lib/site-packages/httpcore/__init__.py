...
try:
    ...
    class AnyIOBackend:  # type: ignore
        def __init__(self, *args, **kwargs):  # type: ignore
            """Placeholder initializer for AnyIOBackend when 'anyio' is not installed.

            This raises a RuntimeError to provide an informative message when code
            attempts to instantiate the backend without the required dependency.
            """
            msg = (
...
try:
    ...
    class TrioBackend:  # type: ignore
        def __init__(self, *args, **kwargs):  # type: ignore
            """Placeholder initializer for TrioBackend when 'trio' is not installed.
