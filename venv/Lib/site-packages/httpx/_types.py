...
class SyncByteStream:
    def __iter__(self) -> Iterator[bytes]:
        """Iterate over the stream, yielding chunks of bytes.

        Subclasses must implement this method to provide byte chunks.
        """
...
class AsyncByteStream:
    async def __aiter__(self) -> AsyncIterator[bytes]:
        """Asynchronously iterate over the stream, yielding chunks of bytes.
